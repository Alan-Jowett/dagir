...
TEST_CASE("render_mermaid outputs nodes, edges, title, and respects rankdir", "[render_mermaid]") {
  ...
  dagir::ir_node n1;
  n1.id = 1;
  n1.attributes.emplace(dagir::ir_attrs::k_label, "Alpha");
  dagir::ir_node n2;
  n2.id = 2;
  n2.attributes.emplace(dagir::ir_attrs::k_label, "Beta");
  ...
  g.global_attrs.emplace(dagir::ir_attrs::k_graph_label, "TestGraph");
  g.global_attrs.emplace(dagir::ir_attrs::k_rankdir, "LR");
